...
export const LoadingIndicator = () => {
  ...
  return loading
    ? (
    <>
      <div className='flex item-center justify-center z-40 absolute top-[23%] lg:top-[4%] left-[2%] lg:left-[25%] h-[300px] lg:h-[550px] w-[350px] lg:w-[700px] bg-custom-bg  bg-cover animate-bg-slide'>
